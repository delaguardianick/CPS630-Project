...
<body>
    ...
    <form id="store-selector" onchange="test(this.value)">
        <div class="row p-3" id="pictures">
                <div class="col-sm">
                    <input type="radio" name="choice" id="choose-1" value="Toronto Flower Gallery" onclick="btnfunction()"/>
                        <label for="choose-1">
                        <img src="source/flower1.jpg" width="300px;">
                    </label>
                    <h4>Toronto Flower Gallery</h4>
                </div>
                <div class="col-sm">
                    <input type="radio" name="choice" id="choose-2" value="Page One Cafe" onclick="btnfunction()"/>
                        <label for="choose-2">
                ...
                <div class="col-sm">
                <input type="radio" name="choice" id="choose-3" value="Tim Hortons" onclick="btnfunction()"/>
                        <label for="choose-3">
