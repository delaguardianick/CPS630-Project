    ...
    <div class="row">
        ...
        <form action="includes/apply2.inc.php" method="post">
            ...
            <div class="form-group">
                ...
                <input type="tel" class="form-control" name="dPhone" placeholder="(123)-456-789">
            </div>
            <div class="form-group">
                <label for="dCity">City</label>
                <input type="text" class="form-control" name="dCity" placeholder="Toronto">
            </div>
            <div class="form-group">
                <label for="dCar">Car Model</label>
                <input type="text" class="form-control" name="dCar" placeholder="Honda Civic 2021">
            </div>
            <label class="mr-sm-2" for="dTier">Select your vehicle tier</label>
                <select class="custom-select mr-sm-2" name="dTier">
