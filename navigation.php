...
<html>
  ...
  <nav class="navbar navbar-expand-lg navbar-dark bg-dark" id="nav-bar">
    <a class="navbar-brand" href="#!index">
      <img src="source/logo2.png" alt="logo" id="logo">
    </a>
      ...
      <ul class="navbar-nav mr-auto">
        ...
        <!-- <li class="nav-item dropdown">
          ...
          <div class="dropdown-menu" aria-labelledby="navbarDropdown">
            <a class="dropdown-item" href="#!rideToDest">Ride to Destination</a>
        ...
        <li class="nav-item">
          ...
          //is the user logged in? if they are then change nav bar
            if(isset($_SESSION["userid"])){
              ...
              //if not logged in
              echo "<li class='nav-item'><a class='nav-link' href='#!signUp'>Sign Up</a></li>";
