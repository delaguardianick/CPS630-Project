                ...
                <div class="col-6 col-md-4" id="summary">
                    <div class="card" id="summary-card">
                        ...
                        <ul class="list-group list-group-flush">
                            ...
                            <li class="list-group-item">Item ID: <div class="value" id="itemId1"></div></li>
                            <li class="list-group-item">Item: <div class="value" id="item1"></div></li>
                            <li class="list-group-item">Store Address: <div class="value" id="address1"></div></li>
